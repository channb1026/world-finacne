...
- **中央**：**关键数据条**（美元指数、VIX、WTI、黄金、在岸人民币）+ 全球地图 + 国家亮点，点击亮点 → 地区情报抽屉（标题可点击打开原文）
- **右侧**：全球股市指数（10 个）+ 市场状态（亚太/欧洲/美洲）+ **利率·波动率**（10Y/2Y 美债、VIX）+ A 股资讯（标题可点击打开原文）
- **底部条**：当前时间（UTC / 北京时）、**数据刷新**（行情 3s · 新闻/快讯/日历 45s）、即将到来的经济事件；**快讯**跑马灯每条可点击在新标签打开原文
...
- 地图区域预设与视角 URL 同步；经济日历与汇率/股市联动；亮点按新情报数量变色；历史回放、自选与告警。
