...
export const messages = {
  ...
  'panel.filterMarketMoving': { zh: '只看市场驱动', en: 'Market-moving only' },
  'panel.filterByCategory': { zh: '按分类筛选', en: 'Filter by category' },
  'panel.filterByWindow': { zh: '按时间窗口筛选', en: 'Filter by time window' },
  'panel.window.1h': { zh: '1小时', en: '1H' },
  'panel.window.4h': { zh: '4小时', en: '4H' },
  'panel.window.24h': { zh: '24小时', en: '24H' },
  'panel.window.all': { zh: '全部时段', en: 'All time' },
  'news.impact.high': { zh: '高影响', en: 'High impact' },
  'news.impact.medium': { zh: '关注', en: 'Watch' },
  'news.currentTheme': { zh: '当前主线', en: 'Current drivers' },
  'news.whyNow': { zh: '关联主线', en: 'Why now' },
  'news.assetImpact': { zh: '影响维度', en: 'Impact' },
  'news.assetOverview': { zh: '跨市场分布', en: 'Cross-market mix' },
  'news.timeline': { zh: '主线回看', en: 'Timeline' },
  'news.themeMix': { zh: '主题集中', en: 'Theme mix' },
  'news.scopeMix': { zh: '区域偏向', en: 'Scope mix' },
  'news.leadSummary': { zh: '今日主线', en: 'Lead summary' },
  'news.lifecycle.new': { zh: '新出现', en: 'New' },
  'news.lifecycle.developing': { zh: '持续发酵', en: 'Developing' },
  'news.lifecycle.watch': { zh: '持续关注', en: 'Watchlist' },
